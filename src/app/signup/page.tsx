...
//              <span>Have a account?<Link href={"/login"} className="underline">Login</Link></span>
//            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">AuraWord</h1>
          <p className="text-purple-200 text-sm">Your personal journaling companion</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-6">
            ...
            <p className="text-purple-200 text-sm">Start your journaling journey today</p>
          </div>
